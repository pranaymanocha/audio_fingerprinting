...
%if exist('/share/workhorse2/pmanocha/record_hashes_hashtable.mat', 'file') == 2
      
%else
%   save('/share/workhorse2/pmanocha/record_hashes_hashtable.mat','HashTable','HashTableCounts')
%end
