function [L,S,T,maxes] = find_landmarks(D,SR,N,f_sd,maxpairsperpeak,C2)
...
if nargin < 5;  N = 7;  end % 7 to get a_dec = 0.998
...
S1=abs(specgram(D,nfft,targetSR,nfft,nfft-round(targetSR/1000*fft_hop)));
